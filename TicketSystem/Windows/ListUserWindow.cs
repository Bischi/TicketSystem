...
namespace TicketSystem.Windows
{
    public partial class ListUserWindow : Form
    {
        ...
        {
            DialogResult result = MessageBox.Show("By deleting the user his tickets will be deleted too! /n Do you want to remove the user?", "SURE?", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
